  ...
  <div>
    ...
    <div className="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="p-6 border-t border-gray-200">
        <div className="flex items-center">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" className="w-8 h-8 text-gray-400"><path d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
        ...
        <div className="ml-12">
          <div className="mt-2 text-sm text-gray-500">
            ...
            CSS framework that doesn&apos;t get in your way. You&apos;ll be
            amazed how easily you can build and maintain fresh, modern designs
      ...
      <div className="p-6 border-t border-gray-200 md:border-l">
        <div className="flex items-center">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" className="w-8 h-8 text-gray-400"><path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
